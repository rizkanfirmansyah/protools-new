                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" id="inviteParticipant">
                                Invite Participant
...
<div class="modal fade" id="takeProject" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="takeProjectLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <img src="<?= base_url('assets/public/images/logo.png') ?>" alt="" class="img-fluid mx-auto mb-3">
                </div>
                <div class="row mx-auto justify-content-center" id="joinProjectID">
